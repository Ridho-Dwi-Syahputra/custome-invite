              ...
              <R delay={100}>
                <div className="glass" style={{ borderRadius: 20, padding: '24px 24px', marginBottom: 48 }}>
                  {[
                    ...
                    { icon: <><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></>, label: 'Waktu', value: '08:30 WIB - 11:00 WIB' },
                    { icon: <><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" /></>, label: 'Tempat', value: 'Laboratory of System Enterprise' },
                  ].map((item, i) => (
                    <div key={i}>
